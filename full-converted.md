![VNM SIMULATION .](media1/media/image1.png){height="125" width="114"}

VNM SIM CENTER CONFIGURATION MANUAL

Version 0.6

# **I. Overview** {#_i_overview}
...
## **2. VNM SimCenter Overview** {#_2_vnm_simcenter_overview}
...
## **3. Software Interface** {#_3_software_interface}
...
### **3.1. Configuration Window** {#_3_1_configuration_window}
...
### **3.2. System Log Window** {#_3_2_system_log_window}
...
## **4. System Requirements** {#_4_system_requirements}
...
## **5. Software Installation** {#_5_software_installation}
...
# **II. Hardware Setup** {#_ii_hardware_setup}
...
## **1. Safety Notice (Direct Drive Wheelbases)** {#_1_safety_notice_(direct_drive_wheelbases)}
...
## **2. USB Connection** {#_2_usb_connection}
...
## **3. Power Connection** {#_3_power_connection}
...
## **4. Mounting the Wheelbase** {#_4_mounting_the_wheelbase}
...
## **5. Attaching the Steering Wheel** {#_5_attaching_the_steering_wheel}
...
## **6. Connecting Additional Devices** {#_6_connecting_additional_devices}
...
## **7. Power-On Procedure** {#_7_power_on_procedure}
...
## **8. Verify Device Detection** {#_8_verify_device_detection}
...
# **III. Wheelbase Configuration** {#_iii_wheelbase_configuration}

## **1. Overview** {#_1_overview}
...
## **2. Basic Settings** {#_2_basic_settings}
...
### **2.3. Steering Range** {#_2_3_steering_range}
...
### **2.4. Max Torque Mode** {#_2_4_max_torque_mode}
...
### **2.5. Overall Gain** {#_2_5_overall_gain}
...
### **2.6. Overall Filter** {#_2_6_overall_filter}
...
### **2.7. User Effects** {#_2_7_user_effects}
...
### **2.8. System Information** {#_2_8_system_information}
...
### **2.9. Game & Car Assignment** {#_2_9_game_&_car_assignment}
...
## **3. Advanced Settings** {#_3_advanced_settings}
...
### **3.1. Crash Effect Reduction** {#_3_1_crash_effect_reduction}
...
### **3.3. Damper Filter** {#_3_3_damper_filter}
...
### **3.4. Inertia Filter** {#_3_4_inertia_filter}
...
### **3.5. Friction Filter** {#_3_5_friction_filter}
...
### **3.6. Bumpstop Range** {#_3_6_bumpstop_range}
...
### **3.7. Lock Strength** {#_3_7_lock_strength}
...
## **4. Game Settings** {#_4_game_settings}

### **4.1. DirectInput Force Feedback Effects** {#_4_1_directinput_force_feedback_effects}
...
![media1/media/image2](media1/media/image2.png){height="490" width="325"}
...
### **4.2. Recommended Usage** {#_4_2_recommended_usage}
...
### **4.3. Some game and effects** {#_4_3_some_game_and_effects}
...
## **5. Wheelbase Profiles** {#_5_wheelbase_profiles}
...
### **5.1 Profile Management** {#_5_1_profile_management}
...
### **5.2. Creating a New Profile** {#_5_2_creating_a_new_profile}
...
### **5.3. Loading a Profile** {#_5_3_loading_a_profile}
...
### **5.4. Saving Profile Changes** {#_5_4_saving_profile_changes}
...
### **5.5. Importing Profiles** {#_5_5_importing_profiles}
...
### **5.6. Sharing Profiles** {#_5_6_sharing_profiles}
...
### **5.7. Automatically Change Profile** {#_5_7_automatically_change_profile}

![media1/media/image3](media1/media/image3.png){height="389" width="622"}
...
### **5.8. Hotkey to Change wheelbase settings and profile** {#_5_8_hotkey_to_change_wheelbase_settings_and_profile}
...
Click Save in the bottom-right corner to apply all changes![media1/media/image4](media1/media/image4.png){height="452" width="507"}

### **5.9. General Settings** {#_5_9_general_settings}
...
### **6.1. Telemetry Force Distribution** {#_6_1_telemetry_force_distribution}
...
### **6.2. Telemetry Plugin** {#_6_2_telemetry_plugin}
...
### **6.3. Installing Telemetry Plugins** {#_6_3_installing_telemetry_plugins}
...
![media1/media/image5](media1/media/image5.png){height="329" width="624"}

### **6.4. Telemetry Effect Parameters** {#_6_4_telemetry_effect_parameters}
...
### **6.5. Telemetry Tab Settings** {#_6_5_telemetry_tab_settings}
...
### **6.6. Games and Telemetry force/ Telemetry Effects** {#_6_6_games_and_telemetry_force/_telemetry_effects}
...
![media1/media/image6](media1/media/image6.png){height="352" width="624"}

![A screenshot of a computer AI-generated content may be incorrect.](media1/media/image7.png){height="164" width="624"}

![A screenshot of a computer AI-generated content may be incorrect.](media1/media/image8.png){height="275" width="624"}**Step 4**\
...
## **7. Telemetry Profiles** {#_7_telemetry_profiles}
...
## **8. Upload firmware** {#_8_upload_firmware}

### **8.1. Purpose & Importance Notes** {#_8_1_purpose_&_importance_notes}
...
### **8.2. Firmware Update Panel** {#_8_2_firmware_update_panel}

![media1/media/image9](media1/media/image9.png){height="491" width="594"}
...
### **8.3. Firmware Update Procedure (DFU Mode)** {#_8_3_firmware_update_procedure_(dfu_mode)}
...
### **8.4. Troubleshooting** {#_8_4_troubleshooting}
...
## **9. Trouble shooting** {#_9_trouble_shooting}

### **9.1. Wheelbase Disconnection** {#_9_1_wheelbase_disconnection}
...
![media1/media/image10](media1/media/image10.png){height="383" width="378"}
...
![media1/media/image11](media1/media/image11.png){height="335" width="507"}
...
![media1/media/image12](media1/media/image12.png){height="222" width="351"}
...
![media1/media/image13](media1/media/image13.png){height="358" width="411"}
